...
/***/ "./resources/js/events/config-events.js":
/*!**********************************************!*\
  !*** ./resources/js/events/config-events.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   permissionsEvents: () => (/* binding */ permissionsEvents),
...
var permissionsEvents = {
  create: function create() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.CREATE_PERMISSION, {
  ...
  edit: function edit() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.EDIT_PERMISSION, {
      detail: _objectSpread({
  ...
  "delete": function _delete() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.DELETE_PERMISSION, {
      detail: _objectSpread({
  ...
  refresh: function refresh() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.REFRESH_PERMISSIONS, {
      detail: _objectSpread({
...
var userEvents = {
  create: function create() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.CREATE_USER, {
      detail: _objectSpread({
  ...
  edit: function edit() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.EDIT_USER, {
      detail: _objectSpread({
  ...
  "delete": function _delete() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.DELETE_USER, {
      detail: _objectSpread({
  ...
  refresh: function refresh() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.REFRESH_USER, {
      detail: _objectSpread({
...
(() => {
/*!********************************************!*\
  !*** ./resources/js/config/permissions.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _events_config_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../events/config-events */ "./resources/js/events/config-events.js");


var tablePermissions = null;
var dtePermissions = null;
function initDomRefs() {
  tablePermissions = document.querySelector("#permissions-table");
}
function initDTEPermissions() {
  dtePermissions = new _components_table__WEBPACK_IMPORTED_MODULE_0__.Table(tablePermissions, "/permission/dt/delete", {
    ajax: {
      ...
      topStart: {
        buttons: [{
          ...
          action: function action(e, dt, node, config) {
            document.dispatchEvent(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.permissionsEvents.create());
          }
        }, {
    ...
    columns: [{
      ...
      render: function render(data, type, row) {
        return "\n                <button class=\"fa-solid fa-pencil btn btn-sm btn-primary\" data-event=\"".concat(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.EDIT_PERMISSION, "\" data-id=\"").concat(row.id, "\"></button>\n                ");
      }
    }]
  }).onClickButton([_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.EDIT_PERMISSION]).buttons([_components_table__WEBPACK_IMPORTED_MODULE_0__.Table.buttons["delete"]]);
}
...
document.addEventListener("DOMContentLoaded", function () {
  setupPermissions();
  document.addEventListener(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.REFRESH_PERMISSIONS, function () {
    console.log("reloading");
    dtePermissions.reload();
  });
  document.addEventListener(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.DELETE_PERMISSION, function (e) {
