...
/* harmony import */ var datatables_net_select_dt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! datatables.net-select-dt */ "./node_modules/datatables.net-select-dt/js/select.dataTables.mjs");
/* harmony import */ var datatables_net_select_dt_css_select_dataTables_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! datatables.net-select-dt/css/select.dataTables.css */ "./node_modules/datatables.net-select-dt/css/select.dataTables.css");
/* harmony import */ var _fetchHeaders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../fetchHeaders */ "./resources/js/fetchHeaders.js");
...
var Table = /*#__PURE__*/function () {
  function Table(selector) {
    var deleteUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    ...
    var userColumns = options.columns || [];
    var mergedColumns = [selectColumn].concat(_toConsumableArray(userColumns));
    ...
    this.datatable = new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"](selector, mergedOptions);
    this.dteEvents = {};
  ...
  return _createClass(Table, [{
    ...
    value: function buttons(_buttons) {
      var _this2 = this;
      var length = this.datatable.buttons().length;
      _buttons.forEach(function (button) {
        var buttonConfig = _objectSpread({}, button);
        if (buttonConfig.name === "delete") {
          buttonConfig.action = /*#__PURE__*/function () {
            var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e, dt, node, config) {
              var selectedRows, selectedIds, response, _t;
              return _regenerator().w(function (_context) {
                while (1) switch (_context.p = _context.n) {
                  case 0:
                    selectedRows = dt.rows({
                      selected: true
                    }).data().toArray();
                  ...
                  case 1:
                    _context.p = 1;
                    _context.n = 2;
                    return fetch(_this2.deleteUrl, {
                      method: "DELETE",
                      headers: _fetchHeaders__WEBPACK_IMPORTED_MODULE_4__.fetchHeaders,
                      body: JSON.stringify({
                        ids: selectedIds
                      })
                    });
        ...
        _this2.datatable.button().add(length, buttonConfig);
        length++;
      });
      return this;
    }
...
/***/ "./resources/js/events/cloud-storage-events.js":
/*!*****************************************************!*\
  !*** ./resources/js/events/cloud-storage-events.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cloudStorageEvents: () => (/* binding */ cloudStorageEvents),
...
var cloudStorageEvents = {
  uploadFile: function uploadFile() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.UPLOAD_FILE, {
  ...
  createDirectory: function createDirectory() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.CREATE_DIRECTORY, {
      detail: _objectSpread({
  ...
  deleteFile: function deleteFile() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.DELETE_FILE, {
      detail: _objectSpread({
  ...
  refresh: function refresh() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.REFRESH, {
      detail: _objectSpread({
        name: names.REFRESH
      }, payload)
    });
  ...
  openDirectory: function openDirectory() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.OPEN_DIRECTORY, {
      detail: _objectSpread({
  ...
  downloadFile: function downloadFile() {
    var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return new CustomEvent(names.DOWNLOAD_FILE, {
      detail: _objectSpread({
...
var csrfToken = (_csrfMetaTag$getAttri = csrfMetaTag === null || csrfMetaTag === void 0 ? void 0 : csrfMetaTag.getAttribute('content')) !== null && _csrfMetaTag$getAttri !== void 0 ? _csrfMetaTag$getAttri : '';
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/datatables.net-select-dt/css/select.dataTables.css":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/datatables.net-select-dt/css/select.dataTables.css ***!
  \***********************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_select_dataTables_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./select.dataTables.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/datatables.net-select-dt/css/select.dataTables.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_select_dataTables_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_select_dataTables_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
const columnVisibility = {
    ...
    _columnText: function (dt, conf) {
        ...
        // Strip HTML comments
        title = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons.stripHtmlComments(title);
        // Use whatever HTML stripper DataTables is configured for
        title = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.stripHtml(title).trim();
...
const copy = function (dt, conf) {
    if (datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.copyHtml5) {
        return 'copyHtml5';
    }
};
const copyHtml5 = {
    ...
    action: function (e, dt, button, config, cb) {
        ...
        var hiddenDiv = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div').css({
            height: '1px',
            width: '1px',
            overflow: 'hidden',
            position: 'fixed',
        ...
        var textarea = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('textarea')
            .prop('readonly', true)
            .val(output)
            .appendTo(hiddenDiv);
        ...
        var message = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('span')
        ...
        var close = function () {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).off('.buttons-copy');
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document)
...
const csv = function (dt, conf) {
    if (typeof datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.csvHtml5 === 'object' &&
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.csvHtml5.available(dt, conf)) {
        return 'csvHtml5';
    }
};
const csvHtml5 = {
    ...
    action: function (e, dt, button, config, cb) {
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].fileSave(new Blob([output], { type: 'text/csv' + charset }), info.filename, true);
        cb();
    },
    async: 100,
    filename: '*',
...
function _addToZip(zip, obj) {
    datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.each(obj, (name, val) => {
        if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(val)) {
...
function _createNode(doc, nodeName, opts) {
    ...
    if (opts) {
        if (opts.attr) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(tempNode).attr(opts.attr);
        }
        if (opts.children) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.each(opts.children, function (key, value) {
...
var _excelMergeCells = function (rels, row, column, rowspan, colspan) {
    var mergeCells = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('mergeCells');
...
const excel = function (dt, conf) {
    if (typeof datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.excelHtml5 === 'object' &&
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.excelHtml5.available(dt, conf)) {
        return 'excelHtml5';
    }
};
//
...
const excelHtml5 = {
    ...
    available: function () {
        return window.FileReader !== undefined &&
            datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons.jszip() !== undefined &&
            _serialiser
            ? true
            : false;
    },
    ...
    action: function (e, dt, button, config, cb) {
        ...
        var addHeader = function (structure) {
            structure.forEach(function (row) {
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('row').last().find('c').attr('s', '2'); // bold
                // Add any merge cells
        ...
        if (exportInfo.title) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('row').last().find('c').attr('s', '51'); // centre
        }
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('worksheet').prepend(cols);
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(workbook).find('sheets sheet').attr('name', _sheetname(config));
        ...
        if (config.autoFilter) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(node).insertBefore(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('mergeCells'));
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(workbook)
                .find('definedNames')
        ...
        let merge = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(rels).find('mergeCells');
        if (merge.children().count() === 0) {
            merge.remove();
        }
        var jszip = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons.jszip();
        var zip = new jszip();
        var zipConfig = {
            compression: 'DEFLATE',
            type: 'blob',
        ...
        if (zip.generateAsync) {
            ...
            zip.generateAsync(zipConfig).then(function (blob) {
                datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].fileSave(blob, filename);
                cb();
            });
        }
        else {
            // JSZip 2.5
            datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].fileSave(zip.generate(zipConfig), filename);
            cb();
        }
    },
    async: 100,
...
const pageLength = function (dt) {
    ...
    if (Array.isArray(lengthMenu[0])) {
        ...
        for (var i = 0; i < lengthMenu.length; i++) {
            ...
            if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(option)) {
...
const pdf = function (dt, conf) {
    if (typeof datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.pdfHtml5 === 'object' &&
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons.pdfHtml5.available(dt, conf)) {
        return 'pdfHtml5';
    }
};
const pdfHtml5 = {
    ...
    available: function () {
        return window.FileReader !== undefined && datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons.pdfMake();
    },
    text: function (dt) {
    ...
    action: function (e, dt, button, config, cb) {
        ...
        var pdf = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons.pdfMake().createPdf(doc);
...
const print = {
    ...
    action: function (e, dt, button, config, cb) {
        ...
        var data = dt.buttons.exportData(datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({ decodeEntities: false }, config.exportOptions));
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('style, link[rel="stylesheet"]').each(function (el) {
        ...
        win.document.body.innerHTML =
            '<h1>' +
                ...
                '</div>';
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(win.document.body).classAdd('dt-print-view');
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(win.document.body)
            .find('img')
            .each(function (img) {
...
Object.assign(datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons, {
    colOrder,
    columnOrder,
    colvis,
    columnsToggle,
...
if (!datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].versionCheck('3')) {
    throw 'Warning: Buttons requires DataTables 3 or newer';
}
// Expose file saver on the DataTables API.
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].fileSave = saveAs;
...
class Buttons {
    ...
    popover(contentIn, hostButton, inOpts) {
        ...
        var c = this.c;
        var closed = false;
        var options = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({
        ...
        var hostNode = options.collectionLayout.includes('fixed')
            ? datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body')
            : hostButton.node();
        var close = function () {
            closed = true;
            fadeOut(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(containerSelector), options.fade, function () {
                this.detach();
            });
            dt.buttons('[aria-haspopup="dialog"][aria-expanded="true"]')
                .nodes()
                .attr('aria-expanded', 'false');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('div.dt-button-background').off('click.dtb-collection');
            Buttons.background(false, options.backgroundClassName, options.fade, hostNode.get(0));
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.off('resize.resize.dtb-collection');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').off('.dtb-collection');
            dt.off('buttons-action.b-internal');
            dt.off('destroy.dtb-popover');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').trigger('buttons-popover-hide.dt');
        };
        if (contentIn === false) {
            close();
            return;
        ...
        let content = typeof contentIn === 'string'
            ? datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div').html(contentIn).children()
            : datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(contentIn);
        // Sort buttons if defined
        if (options.sort) {
            var elements = content.find('button').mapTo(function (el) {
                return {
                    text: datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(el).text(),
                    el: el
                };
            });
        ...
        var display = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(options.tag)
        ...
        if (!hostNode.isAttached()) {
            let possibilities = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document.body).children('div, section, p');
        ...
        var tableContainer = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(hostButton.table().container());
        ...
        if (position === 'absolute') {
            ...
            var offsetParent = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(hostNode.get(0).offsetParent);
            ...
            if (containerPosition.left + left + popoverSizes.width >
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.width()) {
                // Overflowing the document to the right
                left =
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.width() - popoverSizes.width - containerPosition.left;
            }
            ...
            if (containerPosition.top + top + popoverSizes.height >
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.height() + datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.scrollTop()) {
            ...
            if (offsetParent.offset().top + top < datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.scrollTop()) {
            ...
            var place = function () {
                var half = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.height() / 2;
            ...
            place();
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.on('resize.dtb-collection', function () {
                place();
            });
        }
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('div.dt-button-background').on('click.dtb-collection', function () { });
        ...
        setTimeout(function () {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body')
                ...
                if (
                // Background click
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).classHas('dt-button-background') ||
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).classHas('dtb-popover-close') ||
    ...
    destroy() {
        // Key event listener
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').off('keyup.' + this.s.namespace);
    ...
    processing(node, flag) {
        ...
        if (button) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).trigger('buttons-processing.dt', false, [
                flag,
                dt.button(node),
                dt,
                button.node,
    ...
    constructor(dtIn, configIn) {
        let config;
        let dt = new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(dtIn);
        ...
        this.c = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep({}, Buttons.defaults, config);
        ...
        this.dom = {
            container: datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(this.c.dom.container.tag).classAdd(this.c.dom.container.className)
        };
        var that = this;
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('body').on('keyup.' + this.s.namespace, function (e) {
    ...
    _addKey(conf) {
        if (conf.key) {
            this.s.listenKeys += datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(conf.key)
                ? conf.key.key
                : conf.key;
        }
    }
    ...
    _expandButton(attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
        ...
        for (var i = 0, ien = buttons.length; i < ien; i++) {
            ...
            if (built.conf.buttons) {
                built.collection = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(domCollection.container.content.tag);
                built.conf._collection = built.collection;
                this._expandButton(built.buttons, built.conf.buttons, built.conf.split, !isSplit, isSplit, attachPoint, built.conf);
            }
            // And the split collection
            if (built.conf.split) {
                built.collection = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(domCollection.container.tag);
                built.conf._collection = built.collection;
    ...
    _buildButton(config, inCollection, isSplit, inSplit) {
        ...
        var domStructure = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep({}, configDom.button);
        if (inCollection && isSplit && configDom.collection.split) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep(domStructure, configDom.collection.split.action);
        }
        else if (inSplit || inCollection) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep(domStructure, configDom.collection.button);
        }
        else if (isSplit) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep(domStructure, configDom.split.button);
        }
        // Spacers don't do much other than insert an element into the DOM
        if (config.spacer) {
            var spacer = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(domStructure.spacer.tag)
                .classAdd([
                'dt-button-spacer',
                config.style || '',
        ...
        if (!config.html) {
            var run = function (e, dt, button, config, done) {
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).trigger('buttons-action.dt', false, [
                    dt.button(button),
                    dt,
                    button,
                    config
            ...
            button = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(tag)
            ...
            if (domStructure.liner.tag) {
                ...
                var liner = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(lc)
                    .html(text(config.text || ''))
            ...
            button = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div').html(config.html);
        }
        var buttonContainer = this.c.dom.buttonContainer;
        var inserter;
        if (buttonContainer && buttonContainer.tag) {
            inserter = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(buttonContainer.tag)
        ...
        if (isSplit) {
            var dropdownConf = inCollection
                ? datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep(this.c.dom.split, this.c.dom.collection.split)
                : this.c.dom.split;
            var wrapperConf = dropdownConf.wrapper;
            splitDiv = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c(wrapperConf.tag)
                .classAdd(wrapperConf.className)
                .append(button);
            var dropButtonConfig = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign(config, {
                autoClose: true,
            ...
            var dropButton = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('button')
                .classAdd([
        ...
        for (var i = 0; i < buttons.length; i++) {
            ...
            if (button.isSplit) {
                ...
                if (this._checkAnyEnabled(button.buttons)) {
                    // Enable the split
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(splitBtn)
                        .classRemove(this.c.dom.button.disabled)
                        .prop('disabled', false);
                }
                else {
    ...
    _nodeToButton(node, buttons) {
        ...
        if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.dom(node)) {
            node = node.get(0);
        }
        for (var i = 0, ien = buttons.length; i < ien; i++) {
            if (buttons[i].node.get(0) === node ||
    ...
    _keypress(character, e) {
        ...
        var run = function (conf, node) {
            ...
            else if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(conf.key)) {
    ...
    _removeKey(conf) {
        if (conf.key) {
            var character = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(conf.key)
                ? conf.key.key
                : conf.key;
    ...
    _resolveExtends(confIn) {
        ...
        var toConfObject = function (base, lastConfig) {
            ...
            // separately)
            while (!datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(base) && !Array.isArray(base)) {
                if (base === undefined) {
                    return false;
                }
            ...
            return Array.isArray(base) ? base : datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({}, base);
        };
        ...
        while (conf && conf.extend) {
            ...
            conf = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({}, objArray, conf);
...
Buttons.background = function (show, className = '', fade = 400, insertPoint = document.body) {
    if (show) {
        let div = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div').classAdd(className).css('opacity', '0');
        ...
        fadeOut(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('div.' + className), fade, function () {
            this.classRemove(className).remove();
        });
    }
};
Buttons.buttons = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons;
/**
...
Buttons.instanceSelector = function (group, buttons) {
    ...
    var process = function (input) {
        ...
        else if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.element(input)) {
            // Element selector
...
Buttons.buttonSelector = function (insts, selector) {
    ...
    var run = function (selector, inst) {
        ...
        if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.dom(selector)) {
            selector = selector.get();
        }
        if (selector && datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.arrayLike(selector)) {
        ...
        if (selector === null ||
            ...
            if (selector.indexOf(',') !== -1) {
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(nodes)
                    .filter(selector)
                    .each(function (el) {
                    ret.push({
                        inst: inst,
                        node: datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(el)
                    });
                });
            }
        }
        else if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.element(selector)) {
            // Node selector
            var idx = nodes.indexOf(selector);
            if (idx !== -1) {
                ret.push({
                    inst: inst,
                    node: datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(nodes[idx])
                });
            }
        }
    };
...
Buttons.stripData = function (input, config) {
    ...
    if (!config || config.stripHtml) {
        str = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util.stripHtml(str);
    }
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons()', buttonSelector);
// Individual button selector
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('button()', function (group, selector) {
...
// Active buttons
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().active()', 'button().active()', function (flag) {
    if (flag === undefined) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().action()', 'button().action()', function (action) {
    if (action === undefined) {
        return this.map(function (set) {
...
// Collection control
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().collectionRebuild()', 'button().collectionRebuild()', function (buttons) {
    return this.each(function (set) {
        for (var i = 0; i < buttons.length; i++) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register(['buttons().enable()', 'button().enable()'], function (flag) {
    return this.each(function (set) {
        set.inst.enable(set.node, flag);
    });
});
// Disable buttons
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register(['buttons().disable()', 'button().disable()'], function () {
    return this.each(function (set) {
        set.inst.disable(set.node);
    });
});
// Button index
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('button().index()', function () {
    var idx = null;
...
// Get button nodes
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().nodes()', 'button().node()', function () {
    var d = new datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom();
    this.each(function (set) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().processing()', 'button().processing()', function (flag) {
    if (flag === undefined) {
        return this.map(function (set) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().text()', 'button().text()', function (label) {
    if (label === undefined) {
        return this.map(function (set) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().trigger()', 'button().trigger()', function () {
    return this.each(function (set) {
        set.inst.node(set.node).trigger('click');
    });
});
// Button resolver to the popover
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('button().popover()', function (content, options) {
    return this.map(set => {
        return set.inst.popover(content, this.button(this[0].node), options);
    });
});
// Get the container elements
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons().containers()', function () {
    var domInst = new datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom();
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons().container()', function () {
    // API level of nesting is `buttons()` so we can zip into the containers method
    return this.containers().eq(0);
});
// Add a new button
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('button().add()', function (idx, conf, draw = true) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons().destroy()', function () {
    this.pluck('inst')
        .unique()
        .each(function (inst) {
        inst.destroy();
...
// Remove a button
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('buttons().remove()', 'button().remove()', function () {
    this.each(function (set) {
...
var _infoTimer;
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons.info()', function (title, message, time) {
    var that = this;
    let info = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('#datatables_buttons_info');
    if (title === false) {
    ...
    fadeIn(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom
        .c('div')
        .attr('id', 'datatables_buttons_info')
        .classAdd('dt-button-info')
        .html(title)
        .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div')[typeof message === 'string' ? 'html' : 'append'](message))
        .appendTo('body'));
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons.exportData()', function (options) {
    if (this.context.length) {
        return _exportData(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(this.context[0]), options);
    }
});
// Get information about the export that is common to many of the export data
// types (DRY)
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register('buttons.exportInfo()', function (conf) {
    if (!conf) {
        conf = {};
    }
    return {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Buttons = Buttons;
// DataTables creation - check if the buttons have been defined for this table,
// they will have been if the `B` option was used in `dom`, otherwise we should
// create the buttons instance here so they can be inserted into the document
// using the API.
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).on('init.dt plugin-init.dt', function (e, settings) {
    if (e.namespace !== 'dt') {
        return;
    }
    var opts = settings.init.buttons || datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.buttons;
    if (opts && !settings._buttons) {
        new Buttons(settings, opts).container();
    }
});
function _init(settings, options) {
    var api = new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(settings);
    var opts = options
        ? options
        : api.init().buttons || datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.buttons;
    return new Buttons(api, opts).container();
}
// DataTables 1 `dom` feature option
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.feature.push({
    fnInit: _init,
    cFeature: 'B'
});
// DataTables 2 layout feature
if (datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].feature) {
    datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].feature.register('buttons', _init);
}
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
var _filename = function (config, dt) {
    ...
    if (filename.indexOf('*') !== -1) {
        filename = filename.replace(/\*/g, datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('head > title').text()).trim();
    }
...
var _title = function (config, dt) {
    ...
    return title === null
        ? null
        : title.indexOf('*') !== -1
            ? title.replace(/\*/g, datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('head > title').text() || 'Exported data')
            : title;
};
var _message = function (dt, config, option, position) {
    ...
    var caption = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().container()).find('caption').eq(0);
    if (message === '*') {
...
var _exportData = function (dt, inOpts) {
    var config = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep({}, {
        rows: null,
        columns: '',
        modifier: {
            search: 'applied',
    ...
    var footer = dt.table().footer()
        ? dt
            ...
            var val = '';
            if (el) {
                var inner = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(el).find('.dt-column-title');
                val = inner.count() ? inner.html() : datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(el).html();
            }
    ...
    var modifier = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({}, config.modifier);
    if (dt.select &&
        typeof dt.select.info === 'function' &&
        modifier.selected === undefined) {
        if (dt
            .rows(config.rows, datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign({ selected: true }, modifier))
            .any()) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign(modifier, { selected: true });
        }
    }
...
/* harmony export */ });
/* harmony import */ var datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! datatables.net-dt */ "./node_modules/datatables.net-dt/js/dataTables.dataTables.mjs");
/* harmony import */ var datatables_net_select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! datatables.net-select */ "./node_modules/datatables.net-select/js/dataTables.select.mjs");
...
if (!datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"] || !datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].versionCheck('3')) {
    throw 'Error: Select requires DataTables 3 or newer';
}
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].select = {
    classes: {
    ...
    init: function (dt) {
        ...
        var defaults = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.select;
        ...
        else if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(opts)) {
        ...
        if (!setStyle && datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).classHas('selectable')) {
            dt.select.style('os');
        }
...
function checkboxClass(asSelector) {
    var name = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].select.classes.checkbox;
...
function disableMouseSelection(dt) {
    ...
    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().container())
        .off('mousedown.dtSelect', selector)
        .off('mouseup.dtSelect', selector)
        .off('click.dtSelect', selector);
    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').off('click.dtSelect' + _safeId(dt.table().node()));
}
/**
...
function enableMouseSelection(dt) {
    var container = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().container());
    var ctx = dt.settings()[0];
    var selector = ctx._select.selector;
    var matchSelection;
    container
        ...
        if (matchSelection) {
            ...
            if (!selection.anchorNode ||
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(selection.anchorNode.parentNode)
                    .closest('table')
                    .get(0) === dt.table().node()) {
        ...
        if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).closest('div.dt-container').get(0) != container) {
            return;
        }
        var cell = dt.cell(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).closest('td, th').get(0));
    ...
    // Blurable
    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').on('click.dtSelect' + _safeId(dt.table().node()), function (e) {
        if (ctx._select.blurable) {
            // If the click was inside the DataTables container, don't blur
            if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).closest(dt.table().container()).count()) {
                return;
            }
            // Ignore elements which have been removed from the DOM (i.e.
            // paging buttons)
            if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).closest('html').count() === 0) {
                return;
            }
            // Don't blur in Editor form
            if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(e.target).closest('div.DTE').count()) {
                return;
            }
...
function eventTrigger(api, type, args, any) {
    ...
    args.unshift(api);
    let ev = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(api.table().node()).trigger(type, true, args);
...
function info(api, node) {
    ...
    var add = function (el, name, num) {
        el.append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('span')
    ...
    var el = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(node);
    var output = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('span').classAdd('select-info');
    add(output, 'row', rows);
...
function initCheckboxHeader(dt, headerCheckbox) {
    ...
    dt.columns().iterator('column', function (s, idx) {
        ...
        var header = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.column(idx).header());
        ...
        if (!header.find('input').count()) {
            ...
            var input = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('input')
                .attr({
...
function keysSet(dt) {
    ...
    if (flag) {
        ...
        // browser
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.rows({ page: 'current' }).nodes().toArray()).attr('tabindex', 0);
        dt.on('draw.' + namespace, function () {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.rows({ page: 'current' }).nodes().toArray()).attr('tabindex', 0);
        });
        // Listen on document for tab, up and down
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).on('keydown.' + namespace, function (e) {
            var key = e.keyCode;
            var active = document.activeElement;
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.rows().nodes().toArray()).attrRemove('tabindex');
        // Nuke events
        dt.off('draw.' + namespace);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).off('keydown.' + namespace);
    }
}
/**
 ...
 */
function init(ctx) {
    var api = new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx);
    ...
    ctx.callbacks.rowCreated.push(function (row, data, index) {
        ...
        if (d._select_selected ||
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row)
        ...
        for (i = 0, ien = ctx.columns.length; i < ien; i++) {
            if (ctx.columns[i]._select_selected ||
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(d.cells[i]).classAdd(ctx._select.className);
            }
        }
    });
    ...
    api.on('destroy.dtSelect', function () {
        ...
        // trigger events
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(api.rows({ selected: true }).nodes().toArray()).classRemove(api.settings()[0]._select.className);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(api.table().header())
            .find('input.' + checkboxClass(true))
            .remove();
        disableMouseSelection(api);
        api.off('.dtSelect');
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('body').off('.dtSelect' + _safeId(api.table().node()));
    });
}
/**
...
[
    ...
    datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.selector[o.type].push(function (settings, opts, indexes) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.selector.cell.push(function (settings, opts, cells) {
    var selected = opts.selected;
    var rowData;
    var out = [];
...
var apiRegister = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.register;
var apiRegisterPlural = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural;
apiRegister('select()', function () {
    return this.iterator('table', function (ctx) {
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].select.init(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx));
    });
});
...
apiRegister('select.items()', function (items) {
    ...
    return this.iterator('table', function (ctx) {
        ...
        eventTrigger(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx), 'selectItems', [items]);
    });
});
apiRegister('select.keys()', function (flag, wrap) {
    ...
    return this.iterator('table', function (ctx) {
        ...
        keysSet(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx));
    });
});
...
apiRegister('select.style()', function (style) {
    ...
    return this.iterator('table', function (ctx) {
        ...
        var dt = new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx);
        if (style !== 'api') {
            dt.ready(function () {
        ...
        eventTrigger(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx), 'selectStyle', [style]);
    });
});
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api.registerPlural('rows().select()', 'row().select()', function (select = true) {
    var api = this;
    var selectedIndexes = [];
    if (select === false) {
    ...
    this.iterator('row', function (ctx, idx) {
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dtData.tr).classAdd(ctx._select.className);
        ...
        for (var i = 0; i < dtColumns.length; i++) {
            ...
            if (isCheckboxColumn(col)) {
                ...
                if (cells && cells[i]) {
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(cells[i])
                        .find('input.' + checkboxClass(true))
                        .prop('checked', true);
                }
...
apiRegisterPlural('columns().select()', 'column().select()', function (select) {
    ...
    this.iterator('column', function (ctx, idx) {
        ...
        var column = new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx).column(idx);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(column.header()).classAdd(ctx._select.className);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(column.footer()).classAdd(ctx._select.className);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(column.nodes().toArray()).classAdd(ctx._select.className);
    });
...
apiRegisterPlural('cells().select()', 'cell().select()', function (select) {
    ...
    this.iterator('cell', function (ctx, rowIdx, colIdx) {
        ...
        if (data.cells) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(data.cells[colIdx]).classAdd(ctx._select.className);
        }
    });
    this.iterator('table', function (innerCtx, i) {
...
apiRegisterPlural('rows().deselect()', 'row().deselect()', function () {
    ...
    this.iterator('row', function (ctx, idx) {
        ...
        var dtData = ctx.data[idx];
        var dtColumns = ctx.columns;
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dtData.tr).classRemove(ctx._select.className);
        ...
        for (var i = 0; i < dtColumns.length; i++) {
            ...
            if (isCheckboxColumn(col)) {
                ...
                // Make sure the checkbox shows the right state
                if (cells && cells[i]) {
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dtData.cells[i])
                        .find('input.' + checkboxClass(true))
                        .prop('checked', false);
                }
...
apiRegisterPlural('columns().deselect()', 'column().deselect()', function () {
    ...
    this.iterator('column', function (ctx, idx) {
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(column.header()).classRemove(ctx._select.className);
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(column.footer()).classRemove(ctx._select.className);
        ...
        api.cells(null, idx)
            ...
            if (data.cells &&
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(data.cells[cellIdx.column]).classRemove(ctx._select.className);
            }
        });
    });
    this.iterator('table', function (ctx, i) {
...
apiRegisterPlural('cells().deselect()', 'cell().deselect()', function () {
    ...
    this.iterator('cell', function (ctx, rowIdx, colIdx) {
        ...
        if (data.cells && !ctx.columns[colIdx]._select_selected) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(data.cells[colIdx]).classRemove(ctx._select.className);
        }
    });
    this.iterator('table', function (ctx, i) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign(datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons, {
    selected: {
...
['Row', 'Column', 'Cell'].forEach(function (item) {
    ...
    datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.buttons['select' + item + 's'] = {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].type('select-checkbox', {
    className: 'dt-select',
    detect: {
        oneOf: function () {
            return false; // no op
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep(datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.language, {
    select: {
        aria: {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].render.select = function (valueProp, nameProp) {
    var valueFn = valueProp ? datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util.get(valueProp) : null;
    var nameFn = nameProp ? datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util.get(nameProp) : null;
    var fn = function (data, type, row, meta) {
        ...
        if (type === 'display') {
            ...
            return datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('input')
                .attr({
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).prop('checked', datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).closest('tr').classHas(selectedClass));
            })
                .get(0);
        }
        else if (type === 'type') {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].ext.order['select-checkbox'] = function (settings, col) {
    return this.api()
        .column(col, { order: 'index' })
        .nodes()
        .map(function (td) {
        if (settings._select.items === 'row') {
            return datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(td)
                .parent()
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).on('i18n.dt.dtSelect preInit.dt.dtSelect', function (e, ctx) {
    if (e.namespace !== 'dt') {
        return;
    }
    datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].select.init(new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(ctx));
...
(() => {
/*!*********************************************!*\
  !*** ./resources/js/cloud-storage/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_table__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/table */ "./resources/js/components/table.js");
/* harmony import */ var _events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../events/cloud-storage-events */ "./resources/js/events/cloud-storage-events.js");
...
function _readFile() {
  _readFile = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(file) {
...
function initComponents() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 2:
            payload = _context2.v;
            _context2.n = 3;
            return fetch("/cloud-storage/upload/file", {
              method: "POST",
          ...
          case 5:
            ...
            console.error("Error processing or uploading files:", _t);
          case 6:
            _context2.p = 6;
  ...
  backBtn.addEventListener("click", function () {
    ...
    var path = currentDirectory.value;
    var index = path.lastIndexOf('/');
    currentDirectory.value = path.substr(0, index);
    console.log("Current directory: ", currentDirectory.value);
    var container = document.querySelector("#cloudStorageBannerUl");
    var rightMostChild = container.childNodes[container.childNodes.length - 1];
    if (rightMostChild) {
...
function initDTEDocuments() {
  ...
  storageDTE = new _components_table__WEBPACK_IMPORTED_MODULE_0__.Table(storageTable, "/cloud-storage/deleteFile", {
    ajax: {
      ...
      topStart: {
        buttons: [{
          ...
          action: function action(e, dt, node, config) {
            document.dispatchEvent(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.cloudStorageEvents.uploadFile());
          }
        }, {
          text: '<i class="fa-solid fa-folder-plus">',
          className: 'btn btn-warning btn-sm',
          action: function action(e, dt, node, config) {
            document.dispatchEvent(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.cloudStorageEvents.createDirectory());
          }
        }]
      }
    },
    columns: [{
      ...
      render: function render(data, type, row) {
        if (row.is_dir) {
          return "<i class=\"fa-solid fa-folder\"></i> ".concat(data);
        } else {
          return "<i class=\"fa-solid fa-file\"></i> <a href=\"/cloud-storage/getFile/".concat(row.id, "\"> ").concat(data, "</a>");
        }
      }
    }, {
      data: "actions",
      title: "#",
      render: function render(data, type, row) {
        return row.is_dir ? "\n                <button class=\"fa-solid fa-folder-open btn btn-sm btn-primary\" data-event=\"".concat(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.OPEN_DIRECTORY, "\" data-name=\"").concat(row.filename, "\" data-id=\"").concat(row.id, "\"></button>\n            ") : "<button class=\"fa-solid fa-download btn btn-sm btn-success\" data-event=\"".concat(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.DOWNLOAD_FILE, "\" data-id=\"").concat(row.id, "\"></button>");
      }
    }]
  }).buttons([_components_table__WEBPACK_IMPORTED_MODULE_0__.Table.buttons["delete"]]).onClickButton([_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.OPEN_DIRECTORY, _events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.DOWNLOAD_FILE]);
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  setUpCloudStorage();
  document.addEventListener(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.REFRESH, function () {
    storageDTE.reload();
  });
  document.addEventListener(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.OPEN_DIRECTORY, function (e) {
    console.log("Cloud Storage: Opening directroy");
    openDirectory(e);
  });
  document.addEventListener(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.UPLOAD_FILE, function (e) {
    console.log("Cloud Storage: Uploading file");
    fileInput.click();
  });
  document.addEventListener(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.DOWNLOAD_FILE, function (e) {
...
function openDirectory(event) {
  ...
  currentDirectory.value = "".concat(currentDirectory.value, "/").concat(event.target.dataset.name);
  console.log("Opening folder: ".concat(currentDirectory.value));
  var container = document.querySelector("#cloudStorageBannerUl");
  var nuevoLi = document.createElement('li');
  nuevoLi.className = 'nav-item cloudStorageBannerSpace';
  nuevoLi.innerHTML = "<span class=\"nav-link custom-tab-banner rounded-0 text-secondary\">\n        <i class=\"fa-solid fa-angles-right text-secondary me-2\"></i>".concat(event.target.dataset.name, "\n        </span>\n    ");
...
function _downloadFile() {
  _downloadFile = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(fileId) {
    var response, blob, contentDisposition, filename, match, downloadUrl, link, _t2;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return fetch("/cloud-storage/downloadFile/".concat(fileId), {
            headers: _fetchHeaders__WEBPACK_IMPORTED_MODULE_2__.fetchHeaders,
            method: "GET"
          });
        case 1:
