...
function initComponents() {
  ...
  fileInput.onchange = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var files, payload, response, _t3;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 5:
            _context2.p = 5;
            _t3 = _context2.v;
            console.error("Error al procesar o subir los archivos:", _t3);
          case 6:
            return _context2.a(2);
        }
      }, _callee2, null, [[1, 5]]);
...
function initDTEDocuments() {
    ...
    columns: [{
      ...
      render: function render(data, type, row) {
        if (row.is_dir) {
          ...
          return "<i class=\"fa-solid fa-file\"></i> ".concat(data);
        }
      }
    }, {
      data: "actions",
  ...
  }).buttons([_components_table__WEBPACK_IMPORTED_MODULE_0__.Table.buttons["delete"]]).onClickButton([_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.OPEN_DIRECTORY]);
}
