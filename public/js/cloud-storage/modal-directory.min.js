...
(() => {
/*!**************************************************************!*\
  !*** ./resources/js/cloud-storage/modals/modal-directory.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
...
function initComponents() {
  formInstance = new _components_form__WEBPACK_IMPORTED_MODULE_0__.Form(form, "/cloud-storage/create/dir", {
    method: "POST",
    onSuccess: function onSuccess() {
      bootstrapModal.hide();
      document.dispatchEvent(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.cloudStorageEvents.refresh());
    }
  });
}
...
document.addEventListener("DOMContentLoaded", function () {
  document.addEventListener(_events_cloud_storage_events__WEBPACK_IMPORTED_MODULE_1__.names.CREATE_DIRECTORY, function () {
