...
/* harmony export */ });
/* harmony import */ var _fetchHeaders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../fetchHeaders */ "./resources/js/fetchHeaders.js");
    ...
    value: function initEvents() {
      ...
      this.form.addEventListener("submit", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
          var data, response, responseData, _t;
            ...
            while (1) switch (_context.p = _context.n) {
              ...
              case 1:
                ...
                return fetch(_this.url, {
                  ...
                  headers: _fetchHeaders__WEBPACK_IMPORTED_MODULE_0__.fetchHeaders,
                  // Ensure it includes 'Content-Type': 'application/json' and 'Accept': 'application/json'
              ...
              case 4:
                ...
                if (_this.onError) {
                  _this.onError(responseData, response.status);
                }
                return _context.a(2);
              case 5:
                // 4. Successful request (200 / 201)
                if (_this.onSuccess) {
                  _this.onSuccess(responseData);
                }
                _context.n = 7;
                break;
              case 6:
                _context.p = 6;
                _t = _context.v;
                console.error("Network or server error:", _t);
                if (_this.onError) {
                  _this.onError({
    ...
    value: function fillForm(data) {
      ...
      Object.entries(data).forEach(function (_ref2) {
        var _ref3 = _slicedToArray(_ref2, 2),
          key = _ref3[0],
          value = _ref3[1];
        var field = _this2.form.querySelector("[name=\"".concat(key, "\"]"));
        if (!field) return;
        if (field.type === "checkbox") {
          field.checked = Boolean(value);
        } else if (field.type === "radio") {
          var radioOption = _this2.form.querySelector("[name=\"".concat(key, "\"][value=\"").concat(value, "\"]"));
...
(() => {
/*!*********************************************************!*\
  !*** ./resources/js/config/modals/modal-permissions.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
...
var inputPermissionName = null;
var inputGuardName = null;
var form = null;
...
function _initComponents() {
  _initComponents = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var response, data, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          if (!formInstance) {
            formInstance = new _components_form__WEBPACK_IMPORTED_MODULE_0__.Form(form, "/permission/store", {
              method: modalEdit ? "PUT" : "POST",
              onSuccess: function onSuccess() {
                bootstrapModal.hide();
                document.dispatchEvent(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.permissionsEvents.refresh());
              }
            });
          }
          ...
          _context.p = 1;
          _context.n = 2;
          return fetch("/permission/get/".concat(permissionId), {
            method: "GET",
...
document.addEventListener("DOMContentLoaded", function () {
  document.addEventListener(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.CREATE_PERMISSION, function () {
    initModalPermission();
  });
  document.addEventListener(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.EDIT_PERMISSION, function (e) {
