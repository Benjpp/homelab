...
function initDTEUsers() {
  dteUsers = new _components_table__WEBPACK_IMPORTED_MODULE_0__.Table(tableUsers, "/user/delete", {
    ajax: {
      ...
      topStart: {
        buttons: [{
          ...
          action: function action(e, dt, node, config) {
            document.dispatchEvent(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.userEvents.create());
          }
        }]
      }
    },
    columns: [{
      ...
      render: function render(data, type, row) {
        return "\n                <button class=\"fa-solid fa-pencil btn btn-sm btn-primary\" data-event=\"".concat(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.EDIT_USER, "\" data-id=\"").concat(row.id, "\"></button>\n                ");
      }
    }]
  }).onClickButton([_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.EDIT_USER]).buttons([_components_table__WEBPACK_IMPORTED_MODULE_0__.Table.buttons["delete"]]);
}
function setupUsers() {
  initDomRefs();
  initDTEUsers();
...
document.addEventListener("DOMContentLoaded", function () {
  setupUsers();
  document.addEventListener(_events_config_events__WEBPACK_IMPORTED_MODULE_1__.names.REFRESH_USER, function () {
    dteUsers.reload();
  });
});
})();
